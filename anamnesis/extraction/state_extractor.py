...
class RawGenerationData:
    ...
    # ── Attention-residual routing — an OPTIONAL PER-ARCHITECTURE substrate (see
    # feature_families/attn_res.py, which documents the pattern). Present only where the architecture
    # routes over committed blocks; a dense-residual model leaves both fields None and the family is
